package com.project.coffee_li.UT.controller.view.v1;

import com.project.coffee_li.controller.view.v1.EventViewController;
...
import static com.project.coffee_li.controller.Paths.VIEW_V1_BASE_URL;
...
class EventViewControllerUnitTest {
    ...
    void should_return_events() throws Exception {
        // GIVEN
        String url = VIEW_V1_BASE_URL.concat(EVENTS);
